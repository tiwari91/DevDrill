...
A dark-themed interview prep flashcard app for software engineers. Practice 450 questions across 10 topics with exam mode, timed challenges, progress tracking, and keyboard shortcuts.

## Topics (450 Questions)

| Topic | Questions | Difficulty Mix |
|-------|:---------:|----------------|
| System Design | 235 | Easy, Medium, Hard |
